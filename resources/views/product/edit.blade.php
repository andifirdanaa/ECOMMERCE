                        ...
                        <form method="post" action="{{ route('product.update', $product->id ) }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('id_product') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="id_product" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Id Product') }}" value="{{ old('id_product', $product->id_product) }}" required autofocus>
                                 ...
                                 <div class="form-group{{ $errors->has('name_product') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name_product" id="input-kode" class="form-control form-control-alternative{{ $errors->has('kode') ? ' is-invalid' : '' }}" placeholder="{{ __('Name Product') }}" value="{{ old('name_product',$product->name_product) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('product_color') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="product_color" id="input-kode" class="form-control form-control-alternative{{ $errors->has('kode') ? ' is-invalid' : '' }}" placeholder="{{ __('Product Color') }}" value="{{ old('product_color',$product->product_color) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('product_description') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea type="text" name="product_description" id="input-kode" class="form-control form-control-alternative{{ $errors->has('kode') ? ' is-invalid' : '' }}" placeholder="{{ __('Product Description') }}" value="{{ old('product_description', $product->product_description) }}" required autofocus></textarea>
                                ...
                                <label for="image">Upload Image : </label>
                                  <div class="col-sm-7">
                                    <div class="file_input_div">
                                      <div class="file_input">
                                          <img src="{{asset('images/'.$product->image)}}" alt="" width="100px" height="auto" style = "margin : 10px 0 10px 0 "> &nbsp; &nbsp;
                                 ...
                                 <div class="form-group{{ $errors->has('product_prize') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="product_prize" id="input-kode" class="form-control form-control-alternative{{ $errors->has('kode') ? ' is-invalid' : '' }}" placeholder="{{ __('Product Prize') }}" value="{{ old('product_prize',$product->product_prize) }}" required autofocus>
                                 ...
                                 <div class="form-group{{ $errors->has('status') ? ' has-danger' : '' }}">
                                  ...
                                  <div class="controls">
                                      <input type="checkbox" name="feature_item" id="feature_item" value="1" @if($product->feature_item == "1") checked @endif value="1">
                                    </div>
                                </div>
