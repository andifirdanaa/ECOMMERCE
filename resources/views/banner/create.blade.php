                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                 ...
                                 <div class="form-group{{ $errors->has('text_style') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="text_style" id="input-kode" class="form-control form-control-alternative{{ $errors->has('kode') ? ' is-invalid' : '' }}" placeholder="{{ __('Text Style') }}" value="{{ old('text_style') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('content') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea type="text" name="content" id="input-kode" class="form-control form-control-alternative{{ $errors->has('kode') ? ' is-invalid' : '' }}" placeholder="{{ __('Content') }}" value="{{ old('content') }}" required autofocus></textarea>
                                ...
                                <div class="form-group{{ $errors->has('link') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="link" id="input-kode" class="form-control form-control-alternative{{ $errors->has('kode') ? ' is-invalid' : '' }}" placeholder="{{ __('Link') }}" value="{{ old('link') }}" required autofocus>
