						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
									<img src="{{asset('/images/'.$item->image)}}" alt="IMG-PRODUCT" class="img-fluid" style="width: 260px;height: 260px;">
								...
								<div class="block2-txt p-t-20">
									<a href="{{url('/detail/'.$item->id)}}" class="block2-name dis-block s-text3 p-b-5">
										{{$item->name_product}}
									</a>
									<span>Rp.
